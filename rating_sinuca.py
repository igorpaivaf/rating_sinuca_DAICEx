...
resultados_exemplo = [
    ('Estagiário', 'Tarzan', 1, 1),
    ('Estagiário', 'LB', 1, 1),
    ('Estagiário', 'Benga', 1, 1),
    ('Estagiário', 'Lorde', 1, 1),
    ('Estagiário', 'Dornellas', 1, 1),
    ('Vitor', 'Estagiário', 1, 1),
    ('Wesley', 'Vitor', 1, 1),
    ('Wesley', 'Giovanni', 1, 1),
    ('Wesley', 'Vanderley', 1, 1),
    ('Wesley', 'PH da Noite', 1, 1),
    ('Dornellas', 'Vanderley', 1, 1),
    ('Estagiário', 'Dornellas', 1, 1),
    ('Estagiário', 'Vitor', 1, 1),
    ('Estagiário', 'Guto', 1, 1),
    ('PT', 'Heitor', 1, 1),
    ('MT', 'PT', 1, 1),
    ('Xaropinho', 'PT', 1, 1),
    ('Moises', 'Xaropinho', 1, 1),
    ('PT', 'Xaropinho', 1, 1),
    ('PT', 'MT', 1, 1),
    ('Xaropinho', 'Lulu', 1, 1),
    ('Iam', 'Xaropinho', 1, 1),
    ('MT', 'Iam', 1, 1),
    ('Xaropinho', 'Heitor', 1, 1),
    ('MT', 'Xaropinho', 1, 1),
    ('MT', 'Lulu', 1, 1),
    ('Moises', 'Vanderley', 1, 1),
    ('Vanderley', 'Wesley', 1, 1),
    ('Vanderley', 'Iam', 1, 1),
    ('Vanderley', 'MT', 1, 1),
    ('Vanderley', 'Wesley', 1, 1),
    ('Heitor', 'Moises', 1, 1),
